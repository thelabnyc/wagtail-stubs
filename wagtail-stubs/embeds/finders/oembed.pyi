...
class OEmbedFinder(EmbedFinder):
    ...
    def __init__(self, providers: list[dict[str, str | list[str]]] | None = None, options: dict[str, str | int] | None = None) -> None: ...
    def accept(self, url: str) -> bool: ...
    def find_embed(self, url: str, max_width: int | None = None, max_height: int | None = None) -> dict[str, str | int | datetime.datetime | None]: ...
