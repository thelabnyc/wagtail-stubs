...
class IndexView(generic.IndexView):
    ...
    @cached_property
    def needs_usage_count_subquery(self) -> Any: ...
    @cached_property
    def current_collection(self) -> Any: ...
    @cached_property
    ...
    def get_edit_url(self, instance: Any) -> str: ...
    def get_filterset_kwargs(self) -> dict[str, Any]: ...
    def decorate_paginated_queryset(self, object_list: Any) -> Any: ...
...
class CreateView(generic.CreateView):
    ...
    def get_initial_form_instance(self) -> Any: ...
...
class EditView(generic.EditView):
    ...
    def render_to_response(self, context: Any, **response_kwargs: Any) -> Any: ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]: ...
