...
class WorkflowState(models.Model):
    ...
    requested_by: models.ForeignKey[
        AbstractBaseUser | None, AbstractBaseUser | None
    ]
    current_task_state: models.OneToOneField[
        TaskState | None, TaskState | None
    ]
    ...
    def copy_approved_task_states_to_revision(
...
class Task(SpecificMixin, models.Model):
    ...
    def user_can_access_editor(
        self, obj: models.Model, user: AbstractBaseUser
    ) -> bool: ...
    def locked_for_user(
        self, obj: models.Model, user: AbstractBaseUser
    ) -> bool: ...
    ...
    def get_actions(
        self, obj: models.Model, user: AbstractBaseUser
    ) -> list[tuple[str, _StrPromise, bool]]: ...
    def get_form_for_action(
        self, action: str
    ) -> type[TaskStateCommentForm]: ...
...
class TaskState(SpecificMixin, models.Model):
    ...
    def log_state_change_action(
        self, user: AbstractBaseUser | None, action: str
    ) -> None: ...
