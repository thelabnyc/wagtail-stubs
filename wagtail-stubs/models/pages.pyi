...
class PageQuerySet[T: MP_Node](SearchableQuerySetMixin, SpecificQuerySetMixin, TreeQuerySet[T]):
    ...
    def type_q(self, *types: builtins.type) -> Q: ...
    @overload
    def type[SpecificPageT: Page](
        self: PageQuerySet[Page],
        *types: builtins.type[SpecificPageT],
    ) -> PageQuerySet[SpecificPageT]: ...
    @overload
    def type(self, *types: builtins.type[Page]) -> Self: ...
    def not_type(self, *types: builtins.type) -> Self: ...
    def exact_type_q(self, *types: builtins.type) -> Q: ...
    @overload
    def exact_type[SpecificPageT: Page](
        self: PageQuerySet[Page],
        *types: builtins.type[SpecificPageT],
    ) -> PageQuerySet[SpecificPageT]: ...
    @overload
    def exact_type(self, *types: builtins.type[Page]) -> Self: ...
    def not_exact_type(self, *types: builtins.type) -> Self: ...
...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def get_ancestors(self, inclusive: bool = False) -> PageQuerySet[Page]: ...
    def get_descendants(self, inclusive: bool = False) -> PageQuerySet[Page]: ...
    def get_siblings(self, inclusive: bool = True) -> PageQuerySet[Page]: ...
    def get_next_siblings(self, inclusive: bool = False) -> PageQuerySet[Page]: ...
    def get_prev_siblings(self, inclusive: bool = False) -> PageQuerySet[Page]: ...
    def get_children(self) -> PageQuerySet[Page]: ...
    ...
    def get_translations(self, inclusive: bool = False) -> PageQuerySet[Self]: ...
...
class WorkflowPage(models.Model):
    ...
    def get_pages(self) -> PageQuerySet[Page]: ...
