...
def reassign_root_page_locale_on_delete(
    sender: type, instance: Locale, **kwargs: Any
) -> None: ...
...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def route(
        self, request: HttpRequest, path_components: list[str]
    ) -> RouteResult: ...
    ...
    def relative_url(
        self, current_site: Site, request: HttpRequest | None = None
    ) -> str | None: ...
    def get_site(self) -> Site | None: ...
    def get_indexed_instance(self) -> Page | None: ...
    def get_default_privacy_setting(
    ...
    def serve_password_required_response(
        self, request: HttpRequest, form: Any, action_url: str
    ) -> HttpResponse: ...
...
class PagePermissionTester:
    ...
    def can_copy_to(
        self, destination: Page, recursive: bool = False
    ) -> bool: ...
