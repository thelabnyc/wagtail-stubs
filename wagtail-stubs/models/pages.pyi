...
class BasePageManager(models.Manager["Page"]):
...
class PageManager(BasePageManager, PageQuerySet):  # type: ignore[misc]
    def filter(self, *args: Any, **kwargs: Any) -> PageQuerySet: ...  # type: ignore[override]
    def exclude(self, *args: Any, **kwargs: Any) -> PageQuerySet: ...  # type: ignore[override]
    def all(self) -> PageQuerySet: ...  # type: ignore[override]
    def order_by(self, *fields: str) -> PageQuerySet: ...  # type: ignore[override]
...
class Page(AbstractPage, index.Indexed, ClusterableModel, metaclass=PageBase):
    ...
    def get_preview_context(self, request: HttpRequest, *args: Any, **kwargs: Any) -> dict[str, Any]: ...
    def get_template(self, request: HttpRequest, *args: Any, **kwargs: Any) -> str: ...
    def get_preview_template(self, request: HttpRequest, *args: Any, **kwargs: Any) -> str: ...
...
class Comment(ClusterableModel):
    ...
    def log_create(
        self,
        page_revision: Revision | None = None,
        user: AbstractBaseUser | None = None,
    ) -> None: ...
    def log_edit(
        self,
