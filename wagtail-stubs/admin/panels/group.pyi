...
class PanelGroup(Panel):
    children: Sequence[Panel | str]
    permission: str | None
    def __init__(
        self, children: Sequence[Panel | str] = (), *args: Any, permission: str | None = None, **kwargs: Any
    ) -> None: ...
    def clone_kwargs(self) -> dict[str, str | Sequence[Panel | str] | type | dict[str, str] | None]: ...
