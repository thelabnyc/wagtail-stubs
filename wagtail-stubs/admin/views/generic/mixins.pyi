...
class PanelMixin:
    ...
    def get_bound_panel(self, form: Form) -> Any | None: ...
...
class IndexViewOptionalFeaturesMixin:
    ...
    @cached_property
    def list_display(self) -> list[Any]: ...
...
class CreateEditViewOptionalFeaturesMixin:
    ...
    @cached_property
    def current_workflow_task(self) -> Any | None: ...
    @cached_property
    def workflow_tasks(self) -> list[Any]: ...
    def user_has_permission(self, permission: str) -> bool: ...
    def workflow_action_is_valid(self) -> bool: ...
    def get_available_actions(self) -> list[str]: ...
    def get_object(self, queryset: models.QuerySet[Any] | None = ...) -> models.Model | None: ...
