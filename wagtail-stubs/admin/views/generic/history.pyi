...
def get_actions_for_filter(queryset: models.QuerySet[Any]) -> list[tuple[str, str]]: ...
...
class HistoryFilterSet(WagtailFilterSet):
    ...
    def get_users_queryset(self) -> models.QuerySet[Any]: ...
...
class ActionColumn(Column):
    ...
    def get_status(self, instance: Any, parent_context: dict[str, Any]) -> str | None: ...
    def get_actions(self, instance: Any, parent_context: dict[str, Any]) -> list[dict[str, str]]: ...
...
class HistoryView(PermissionCheckedMixin, BaseObjectMixin, BaseListingView):
    ...
    def get_context_data(self, *args: Any, object_list: Any | None = None, **kwargs: Any) -> dict[str, Any]: ...
    def get_base_queryset(self) -> models.QuerySet[Any]: ...
    def _annotate_queryset(self, queryset: models.QuerySet[Any]) -> models.QuerySet[Any]: ...
...
class WorkflowHistoryDetailView(BaseObjectMixin, WagtailAdminTemplateMixin):
    ...
    @cached_property
    def tasks(self) -> models.QuerySet[Any]: ...
    @cached_property
