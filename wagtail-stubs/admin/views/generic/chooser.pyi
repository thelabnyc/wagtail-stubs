...
class BaseChooseView(
    ...
    def apply_object_list_ordering(
        self, objects: models.QuerySet[models.Model]
...
class ChosenResponseMixin:
    ...
    def _wrap_chosen_response_data(
        self, response_data: dict[str, Any] | list[dict[str, Any]]
    ) -> JsonResponse: ...
    def get_multiple_chosen_response(
        self, items: Iterable[models.Model]
    ) -> JsonResponse: ...
