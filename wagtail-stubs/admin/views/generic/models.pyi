...
class IndexView(
    ...
    @cached_property
    def add_item_label(self) -> _StrOrPromise: ...
    @cached_property
    def verbose_name_plural(self) -> _StrOrPromise | None: ...
...
class CreateView(
    ...
    error_message: _StrOrPromise | None
    submit_button_label: _StrOrPromise
    submit_button_active_label: _StrOrPromise
    actions: list[str]
    action: str
    object: models.Model
    ...
    def get_success_message(self, instance: models.Model) -> _StrOrPromise | None: ...
    def get_success_buttons(self) -> list[tuple[str, str, bool]]: ...
    def get_error_message(self) -> _StrOrPromise | None: ...
    @cached_property
...
class EditView(
    ...
    template_name: str
    permission_required: str
    delete_item_label: _StrOrPromise
    success_message: _StrOrPromise | None
    error_message: _StrOrPromise | None
    submit_button_label: _StrOrPromise
    submit_button_active_label: _StrOrPromise
    ...
    def save_instance(self) -> models.Model: ...
    def save_action(self) -> HttpResponseRedirect: ...
    def get_success_message(self) -> _StrOrPromise | None: ...
    def get_success_buttons(self) -> list[tuple[str, str, bool]]: ...
    def get_error_message(self) -> _StrOrPromise | None: ...
    def form_valid(self, form: BaseForm) -> HttpResponse: ...
    def form_invalid(self, form: BaseForm) -> HttpResponse: ...
...
class RevisionsCompareView(WagtailAdminTemplateMixin, TemplateView):
    ...
    edit_url_name: str | None
    history_url_name: str | None
    edit_label: _StrOrPromise
    history_label: _StrOrPromise
    page_title: _StrOrPromise
    template_name: str
    model: type[models.Model] | None
    pk: str
