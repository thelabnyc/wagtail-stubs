...
_FilterValue = str | list[str] | models.Model | QuerySet[models.Model] | slice
...
class BaseFilterAdapter:
    ...
    def __init__(self, filter: django_filters.Filter, bound_field: BoundField, value: _FilterValue, base_url: str, query_dict: QueryDict) -> None: ...
...
class MultipleChoiceFilterAdapter(BaseFilterAdapter):
    def get_active_filters(self) -> Generator[ActiveFilter, None, None]: ...
...
class RangeFilterAdapter(BaseFilterAdapter):
    ...
    def format_value(self, value: str | int | float | date | None) -> str: ...
    def get_active_filters(self) -> Generator[ActiveFilter]: ...
...
def register_filter_adapter_class(filter_class: type[django_filters.Filter], adapter_class: type[BaseFilterAdapter] | None = ..., exact_class: bool = False) -> None: ...
