...
class BaseChooser(widgets.Input):
    ...
    def value_from_datadict(self, data: Mapping[str, Any], files: MultiValueDict[str, UploadedFile], name: str) -> str | None: ...
    def get_hidden_input_context(self, name: str, value: str | None, attrs: dict[str, Any] | None) -> dict[str, Any]: ...
    ...
    def render(self, name: str, value: int | str | models.Model | None, attrs: dict[str, Any] | None = None, renderer: BaseRenderer | None = None) -> SafeString: ...
    @property
