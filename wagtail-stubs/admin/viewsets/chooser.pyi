...
class ChooserViewSet(ViewSet):
    ...
    widget_telepath_adapter_class: type[Any] | None
    base_block_class: type[ChooserBlock]
    register_widget: bool
    creation_form_class: type[Any] | None
    ...
    @property
    def choose_view(self) -> Any: ...
    @property
    def choose_results_view(self) -> Any: ...
    @property
    def chosen_view(self) -> Any: ...
    @property
    def chosen_multiple_view(self) -> Any: ...
    @property
