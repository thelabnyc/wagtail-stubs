...
class ModelViewSet(ViewSet):
    ...
    @property
    def add_view(self) -> Any: ...
    @property
    def edit_view(self) -> Any: ...
    @property
    def delete_view(self) -> Any: ...
    @property
    def history_view(self) -> Any: ...
    @property
    def history_results_view(self) -> Any: ...
    @property
    def usage_view(self) -> Any: ...
    @property
    def inspect_view(self) -> Any: ...
    @property
    ...
    @cached_property
    def list_display(self) -> list[str | Any] | object: ...
    @cached_property
    def list_filter(self) -> list[str] | None: ...
    @cached_property
    def filterset_class(self) -> type[Any] | object: ...
    @cached_property
    ...
    @cached_property
    def menu_item_class(self) -> type[Any]: ...
    def formfield_for_dbfield(self, db_field: models.Field[Any, Any], **kwargs: Any) -> Any: ...
