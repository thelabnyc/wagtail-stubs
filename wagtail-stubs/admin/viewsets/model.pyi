...
from wagtail.admin.viewsets.base import ViewSet, ViewSetGroup, _Undefined
...
class ModelViewSet(ListingViewSetMixin, ViewSet):
    ...
    sort_order_field: str | None | _Undefined
    pk_path_converter: str
    ...
    reorder_view_class: type[generic.ReorderView]
    template_prefix: str
    list_per_page: int
    ...
    @cached_property
    def reorder_view_enabled(self) -> bool: ...
    ...
    def get_reorder_view_kwargs(self, **kwargs: Any) -> dict[str, Any]: ...
    @property
    ...
    @property
    def reorder_view(self) -> Callable[..., HttpResponseBase]: ...
    ...
    @cached_property
    def search_fields(self) -> list[str] | tuple[str, ...] | None | _Undefined: ...
    @cached_property
    def search_backend_name(self) -> str | None | _Undefined: ...
    @cached_property
    ...
    def get_form_fields(self) -> Sequence[str] | None: ...
    def get_exclude_form_fields(self) -> Sequence[str] | None: ...
...
class ModelViewSetGroup(ViewSetGroup):
    ...
    @cached_property
    def menu_label(self) -> str | _StrPromise: ...
