...
class FilteredModelChoiceField(django_filters.fields.ModelChoiceField):
    ...
    def __init__(self, queryset: models.QuerySet[models.Model] | models.manager.Manager[models.Model] | None = None, *, filter_accessor: str | Callable[[models.Model], models.QuerySet[models.Model]], filter_field: str, empty_label: str | None = ..., required: bool = ..., widget: Widget | type[Widget] | None = ..., label: str | None = ..., initial: str | None = ..., help_text: str = ..., to_field_name: str | None = ..., limit_choices_to: dict[str, str] | models.Q | None = ..., blank: bool = ..., **kwargs: str | bool | int | None) -> None: ...
...
class WagtailFilterSet(django_filters.FilterSet):
    def __init__(self, data: QueryDict | dict[str, str] | None = None, queryset: models.QuerySet[models.Model] | None = None, *, request: HttpRequest | None = None, prefix: str | None = None) -> None: ...
    @classmethod
    def filter_for_lookup(cls, field: models.Field, lookup_type: str) -> tuple[type[django_filters.Filter], dict[str, Any]]: ...
...
class PopularTagsFilter(django_filters.MultipleChoiceFilter):
    use_subquery: bool
    def __init__(self, field_name: str | None = None, lookup_expr: str | None = None, *, use_subquery: bool = False, label: str | None = None, method: str | Callable[..., models.QuerySet[models.Model]] | None = None, distinct: bool = ..., exclude: bool = ..., conjoined: bool = ..., null_value: str = ..., **kwargs: str | bool | int | Widget | type[Widget] | None) -> None: ...
...
class BaseMediaFilterSet(WagtailFilterSet):
    ...
    usage_count: bool
    def __init__(self, data: QueryDict | dict[str, str] | None = None, queryset: models.QuerySet[models.Model] | None = None, *, request: HttpRequest | None = None, prefix: str | None = None, is_searching: bool | None = None) -> None: ...
