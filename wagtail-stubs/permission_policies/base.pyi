...
class BasePermissionPolicy:
    ...
    def users_with_permission(self, action: str) -> QuerySet[AbstractBaseUser]: ...
    ...
    def instances_user_has_permission_for(self, user: AbstractBaseUser, action: str) -> QuerySet[Model]: ...
    def users_with_any_permission_for_instance(
        self, actions: Iterable[str], instance: Model
    ) -> QuerySet[AbstractBaseUser]: ...
    def users_with_permission_for_instance(self, action: str, instance: Model) -> QuerySet[AbstractBaseUser]: ...
...
class BaseDjangoAuthPermissionPolicy(BasePermissionPolicy):
    def __init__(self, model: type[Model] | str, auth_model: type[Model] | str | None = None) -> None: ...
    @cached_property
