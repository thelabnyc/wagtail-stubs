...
class PagePermissionPolicy(OwnershipPermissionPolicy):
    ...
    def users_with_permission(
        self, action: str, include_superusers: bool = True
    ) -> QuerySet[AbstractBaseUser]: ...
    def user_has_permission_for_instance(
        self, user: AbstractBaseUser, action: str, instance: Page
    ) -> bool: ...
    ...
    def instances_with_direct_explore_permission(
        self, user: AbstractBaseUser
    ) -> QuerySet[Page] | list[Page]: ...
