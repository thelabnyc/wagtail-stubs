...
class AbstractRendition(ImageFileMixin, models.Model):
    ...
    def attrs(self) -> str: ...
    @property
    def attrs_dict(self) -> OrderedDict[str, str | int]: ...
    @property
    def full_url(self) -> str: ...
    @property
    def filter(self) -> Filter: ...
    @cached_property
    def focal_point(self) -> Rect | None: ...
    @property
    def background_position_style(self) -> str: ...
    @property
    def background_position_x(self) -> str: ...
    @property
    def background_position_y(self) -> str: ...
    def img_tag(self, extra_attributes: dict[str, Any] = ...) -> SafeString: ...
